...
/**
 * 卡操作手续费明细通知对象 tbl_card_apply_fee_detail_
 * 
 * @author ruoyi
 * @date 2024-08-15
 */
public class TblCardApplyFeeDetail extends BaseEntity
{
    ...
    public void setCardApplyTableId(Long cardApplyTableId) 
    {
        this.cardApplyTableId = cardApplyTableId;
    }

    public Long getCardApplyTableId() 
    {
        return cardApplyTableId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("id", getId())
            .append("cardApplyTableId", getCardApplyTableId())
